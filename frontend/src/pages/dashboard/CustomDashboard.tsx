      ...
      case 'ventas':
        return (
          <DashboardSection title="Ventas">
            ...
            <div className="mt-4">
              <button className="bg-blue-500 text-white px-4 py-2 rounded mr-2">Nueva Venta</button>
              <button className="bg-gray-500 text-white px-4 py-2 rounded">Ver Facturas</button>
            </div>
          </DashboardSection>
        );
      case 'inventario':
          ...
          <DashboardSection title="Inventario">
            ...
            <div className="mt-4">
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h3 className="font-medium text-yellow-800">Productos con stock bajo</h3>
                <p className="text-sm text-yellow-600">3 productos necesitan reposición</p>
              </div>
            </div>
          </DashboardSection>
        );
          ...
          <DashboardSection title="Configuración">
            ...
            <div className="mt-4 space-y-4">
              <div className="border p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600">Nombre de empresa, logo, etc.</p>
              </div>
              <div className="border p-4 rounded-lg">
