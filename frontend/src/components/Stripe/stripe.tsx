  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8 text-center">
      <div className="max-w-md mx-auto">
        <div className="mb-6">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-14 h-14 sm:w-16 sm:h-16 text-white" fill="currentColor" viewBox="0 0 1024 1024">
        ...
        <button
          onClick={handleClick}
          className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer"
        >
          Conectar con Stripe
        </button>
        
        <p className="text-xs text-gray-500 mt-4">
          Stripe es una plataforma segura para procesar pagos en línea
        </p>
      </div>
    </div>
  );
